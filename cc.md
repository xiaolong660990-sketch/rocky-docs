...
**CC (Canton Coin)** is the Canton Network's native reward asset. Canton runs programs that distribute CC to the apps and infrastructure driving real ecosystem activity — and Rocky is built to earn CC and create durable demand for it.
...
{% hint style="info" %}
CC is Canton's ecosystem asset, not a claim on Rocky. Reward rules, eligibility, and any conversions follow the official Canton and Rocky announcements.
{% endhint %}
